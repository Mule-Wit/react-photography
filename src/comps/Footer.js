    ...
    <footer>
      <div className="contact-area">
        <div className="contact">
          <main>
            <section>
              <div className="content">
                <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/256492/_mLIxaKY_400x400.jpg" alt="profile" />

                <aside>
                  <h1>Acita</h1>
                  <p>Hi, I'm Acita and I'm interested in Photgraphy so this web shows my weekly Photography with my phone small digital camera .</p>
                </aside>
          ...
          <nav>
            <a href="https://mail.google.com/" className="gmail">
              <div className="icon">
            ...
            <a href="https://www.facebook.com/profile.php?id=100015146529072" className="facebook">
              <div className="icon">
            ...
            <a href="https://twitter.com/Yam39624214" className="twitter">
              <div className="icon">
